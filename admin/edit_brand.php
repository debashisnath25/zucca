...
if(isset($_POST['submit_brand']))
{
	...
	$update_brand = mysqli_query($mysqli,"UPDATE brand SET brand_name='".$brand_name."' where brand_id='$get_brand_id'");
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
													<div class="input-group">
														...
														<input type="text" name="brand_name" data-required="1" class="form-control" value="<?php echo $fetch_brand_info['brand_name'];?>">
													</div>
												</div>
                                            </div>											
										</div>											
