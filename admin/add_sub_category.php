...
if(isset($_POST['submit_sub_category']))
{
	...
	$add_sub_cat_image = mysqli_query($mysqli,"INSERT INTO sub_category Values ('','$sub_cat_name','$cat_type','')");
	if($add_sub_cat_image){
		$data = "success";
	}else{
		$data = "error";
	}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
													<div class="input-group">
														...
														<input type="text" name="sub_cat_name" data-required="1" class="form-control" placeholder="Enter The Sub Category Name"/>
													</div>
												</div>
                                            </div>											
										</div>											
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-4 col-md-6">
                                                    <input type="submit" class="btn green" name="submit_sub_category" value="Submit">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
