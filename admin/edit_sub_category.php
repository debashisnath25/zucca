...
if(isset($_POST['submit_subcategory']))
{
	...
	$update_subcat = mysqli_query($mysqli,"UPDATE sub_category SET subcat_name='".$subcat_name."', cat_id='".$cat_id."' where subcat_id='$get_subcat_id'");
                    ...
                    <div class="row">
						...
						?>
                                ...
                                <div class="portlet-body">
									...
									<?php
									$get_subcat_details = mysqli_query($mysqli,"select * from sub_category where subcat_id = '$get_subcat_id'");
									$fetch_subcat_info = mysqli_fetch_array($get_subcat_details);
									?>
                                                ...
                                                <div class="col-md-9">
													<div class="input-group col-md-12">
														...
														<select class="form-control select2me " name="cat_type">
															<option value="<?php echo $fetch_subcat_info['cat_id'];?>" selected disabled>
															<?php 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
													<div class="input-group">
														...
														<input type="text" name="sub_cat_name" data-required="1" class="form-control" value="<?php echo $fetch_subcat_info['subcat_name'];?>">
													</div>
												</div>
                                            </div>											
										</div>											
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-2 col-md-6">
                                                    <input type="submit" class="btn green" name="submit_subcategory" value="Submit">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
