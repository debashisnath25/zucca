...
if(isset($_POST['submit_brand']))
{
	...
	$add_brand = mysqli_query($mysqli,"INSERT INTO brand Values ('','$brand_name','')");
	if($add_brand){
		$data = "success";
	}else{
		$data = "error";
						...
						?>
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">Add Brand</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
													<div class="input-group">
														...
														<input type="text" name="brand_name" data-required="1" class="form-control" placeholder="Enter The Brand Name"/>
													</div>
												</div>
                                            </div>											
										</div>											
