                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
													<div class="input-group">
														...
														<input type="text" name="cat_name" data-required="1" class="form-control" placeholder="Enter The Category Name"/>
													</div>
												</div>
                                            </div>	
													...
													<div class="fileinput fileinput-new" data-provides="fileinput">
														...
														<br/>
															<span class="btn default btn-file">
																...
																<input type="file" name="cat_image" required style="width: 335px; height: 255px;"> 
															</span>
