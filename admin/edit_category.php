...
$fetch_cat_image = mysqli_fetch_array($get_cat_image);

$uploaded_image = $fetch_cat_image['category_image'];
                    ...
                    <div class="row">
						...
						?>
                                ...
                                <div class="portlet-body">
									...
									<?php
									$get_cat_details = mysqli_query($mysqli,"select * from category where cat_id = '$get_cat_id'");
									$fetch_cat_info = mysqli_fetch_array($get_cat_details);
									?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
													<div class="input-group">
														...
														<input type="text" name="cat_name" class="form-control" value="<?php echo $fetch_cat_info['category_name'];?>"/>
													</div>
												</div>
                                            </div>	
													...
													<div class="fileinput fileinput-new" data-provides="fileinput">
														...
														<br/>
															<span class="btn default btn-file">
																...
																<input type="file" name="cat_image" style="width: 335px; height: 255px;"> 
															</span>
